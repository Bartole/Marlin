...
#define STRING_CONFIG_H_AUTHOR "(Bart van Tol)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "E3-Pro Henk"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 141.2 }
